...
locals {
  private_key_file = var.private_key_file == "" ? "/root/tang-automation-powervs/infra/infra-node/data/id_rsa" : var.private_key_file
  public_key_file  = var.public_key_file == "" ? "/root/tang-automation-powervs/infra/infra-node/data/id_rsa.pub" : var.public_key_file
